...
| 모드 | 지원 범위 | 사용법 |
|---|---|---|
| **✨ 만나기(쇼케이스)** | 전 기기 | [✨ 라온 프렌즈 만나러 가기]를 누르면 카메라·권한 없이 예쁜 배경 위에서 캐릭터가 바로 등장해 안내를 진행해요 — 가장 빠르고 실패 없는 기본 경로예요. 실제 공간(바닥·카드)에 붙는 AR을 원하면 아래 카드 마커·WebXR·AR Quick Look 모드를 사용하세요. |
