...
export const STRINGS = {
  ko: {
    ...
    ui: {
      ...
      markerSummoned: '{name} 소환 완료! 함께 갈게요 ✨',
      markerLostHint: '카드를 다시 비추면 그 자리에 딱 붙어요 🃏',
      btnHome: '🏠',
      btnHomeAria: '처음 화면으로 돌아가기',
      gyroOffHint: '📍 시점 고정 모드예요 — 기기 설정에서 \'동작 및 방향\' 접근을 허용하면 캐릭터가 공간에 붙어요',
      overlayLookHint: '📍 제자리에서 천천히 둘러보세요 — 걸어가면 친구가 살짝 밀려나요!',
      ...
      sizeChips: { base: '🐯 기본', life: '🧍 등신대', giant: '🦖 자이언트' },
      sizeChipsAria: '캐릭터 크기 선택',
      operatorFabAria: '운영자 설정',
      operatorTitle: '⚙️ 부스 운영 설정',
      opKiosk: '키오스크 모드 (무입력 시 자동 리셋)',
      opMirror: '매직 미러 (전면 카메라 — 노트북+TV용)',
      opDashboard: '📊 부스 대시보드 열기',
      opApply: '이 설정으로 열기 (URL 북마크 가능)',
      opClose: '닫기',
      langToggleLabel: '🌐 English',
      langToggleAria: '영어로 전환',
      btnVision: 'AI가 알아봐요',
      btnVisionBadge: '체험 🧪',
      visionLoadingLabel: '불러오는 중... ⏳',
      visionHint: '라온 프렌즈 카드나 그림을 카메라에 비춰보세요! 잠시 기다리면 알아볼게요 🔍',
  ...
  en: {
    ...
    ui: {
      ...
      markerSummoned: "{name} summoned! Let's go together ✨",
      markerLostHint: 'Point at the card again to snap right back 🃏',
      btnHome: '🏠',
      btnHomeAria: 'Back to the start screen',
      gyroOffHint: '📍 Fixed-view mode — allow \'Motion & Orientation\' access in settings to pin friends in space',
      overlayLookHint: '📍 Look around from where you stand — walking makes friends drift!',
      ...
      btnQuickLook: '📍 Place on your real floor',
      btnNext: 'Next ▶',
      ...
      sizeChips: { base: '🐯 Normal', life: '🧍 Life-size', giant: '🦖 Giant' },
      sizeChipsAria: 'Choose character size',
      operatorFabAria: 'Operator settings',
      operatorTitle: '⚙️ Booth Settings',
      opKiosk: 'Kiosk mode (auto-reset when idle)',
      opMirror: 'Magic mirror (front camera — for laptop+TV)',
      opDashboard: '📊 Open booth dashboard',
      opApply: 'Open with these settings (bookmarkable URL)',
      opClose: 'Close',
      langToggleLabel: '🌐 한국어',
      langToggleAria: 'Switch to Korean',
      btnVision: 'AI recognizes you',
      btnVisionBadge: 'Beta 🧪',
      visionLoadingLabel: 'Loading... ⏳',
      visionHint: 'Point your camera at a Raon Friends card or picture! Give it a moment to recognize 🔍',
